...
def sphere_phantoms(step_by_step=False):
    ...
    if step_by_step:
        aphantom.plotPhantom(
            filename=outpath + "waterOnly.png",
            voxelSizeFactors=voxelSizeFactors,
            alpha=alpha,
        )
    ...
    if step_by_step:
        aphantom.plotPhantom(
            filename=outpath + "2.0IodineOnly.png",
            voxelSizeFactors=voxelSizeFactors,
            alpha=alpha,
        )
    ...
    aphantom.plotPhantom(
        filename=outpath + "myPhantom.png",
        voxelSizeFactors=voxelSizeFactors,
        alpha=alpha,
    )
...
def sphere_cylinder_phantoms(step_by_step=False):
    ...
    if step_by_step:
        aphantom.plotPhantom(
            filename=outpath + "backgroundAir.png",
            voxelSizeFactors=voxelSizeFactors,
            alpha=alpha,
        )
...
def caffeine_cylinder_phantoms(
    step_by_step=False, caffeine_only=False, water_only=False
):
